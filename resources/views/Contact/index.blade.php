		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<h4 class="montserrat-text uppercase" style="margin-top:100px">{{ $contact1->judul}}</h4>
					<p>{{ $contact1->subjudul}}</p>
					...
					<p>
						...
						{{ $contact1->nomor}}<br/>
						{{ $contact1->nomor}}<br/>
						<div><a href="mailto:email@website.com" class="link">{{ $contact1->email}}</a></div>
					</p>
			...
			<div class="col-md-6 col-sm-12">
				<div class="row">
					<div class="white-section" style="padding:20px">
						<span class="montserrat-text uppercase" style="font-size:24px">{{ $contact3->judul}}</span>
						<p>
							{{ $contact2->isi}}
						</p>
						<form action="#" method="post">
